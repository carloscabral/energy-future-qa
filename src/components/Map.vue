        ...
        <div class="row align-items-start dealership-container">
            <div class="col-lg-6 dealership-map">
                <ul class="dealership-map__companies">
                    <li class="dealership-map__list">
                        <a href="/author/AES Tietê" class="dealership-map__link" @mouseover="activeLogo = 'aes'" @mouseleave="activeLogo = ''">
                            <g-image src="../assets/images/img-logo-aes.svg" width="250" alt="Logo AES" />
                        </a>
                    </li>
                    <li class="dealership-map__list">
                        <a href="/author/Energisa" class="dealership-map__link" @mouseover="activeLogo = 'energisa'" @mouseleave="activeLogo = ''">
                    ...
                    <li class="dealership-map__list">
                        <a href="/author/Enel" class="dealership-map__link" @mouseover="activeLogo = 'enel'" @mouseleave="activeLogo = ''">
                            <g-image src="../assets/images/img-logo-enel.svg" width="250" alt="Logo Enel" />
                        </a>
                    </li>
                    <li class="dealership-map__list">
                        <a href="/author/Light" class="dealership-map__link" @mouseover="activeLogo = 'light'" @mouseleave="activeLogo = ''">
                            <g-image src="../assets/images/img-logo-light.svg" width="250" alt="Logo Light" />
                        </a>
                    </li>              
                    <li class="dealership-map__list">
                        <a href="/author/Santo Antônio" class="dealership-map__link" @mouseover="activeLogo = 'antonio'" @mouseleave="activeLogo = ''">
                            <g-image src="../assets/images/img-logo-antonio.svg" width="250" alt="Logo Santo Antonio" />
                        </a>
                    </li>                                                                      
                </ul>

                <svg version="1.1" id="svg-map" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="90%" viewBox="0 0 450 460" enable-background="new 0 0 450 460" xml:space="preserve">
                    <g>
                    <a xlink:href="#tocantins" :class="{ tocantins : countryList.includes('tocantins') }">
                    ...
                    <a xlink:href="#bahia" :class="{ bahia : countryList.includes('bahia') }">
                    ...
                    <a xlink:href="#sergipe" :class="{ sergipe : countryList.includes('sergipe') }">
                    ...
                    <a xlink:href="#pernambuco" :class="{ pernambuco : countryList.includes('pernambuco') }">
                    ...
                    <a xlink:href="#alagoas" :class="{ alagoas : countryList.includes('alagoas') }">
                    ...
                    <a xlink:href="#riograndedonorte" :class="{ riograndedonorte : countryList.includes('rio-grande-do-norte') }">
                    ...
                    <a xlink:href="#ceara" :class="{ ceara : countryList.includes('ceara') }">
                    ...
                    <a xlink:href="#piaui" :class="{ piaui : countryList.includes('piaui') }">
                    ...
                    <a xlink:href="#maranhao" :class="{ maranhao : countryList.includes('maranhao') }">
                    ...
                    <a xlink:href="#amapa" :class="{ amapa : countryList.includes('amapa') }">
                    ...
                    <a xlink:href="#roraima" :class="{ roraima : countryList.includes('roraima') }">
                    ...
                    <a xlink:href="#amazonas" :class="{ amazonas : countryList.includes('amazonas') }">
                    ...
                    <a xlink:href="#acre" :class="{ acre : countryList.includes('acre') }">
                    ...
                    <a xlink:href="#rondonia" :class="{ rondonia : countryList.includes('rondonia') }">
                    ...
                    <a xlink:href="#matogrosso" :class="{ matogrosso : countryList.includes('mato-grosso') }">
                    ...
                    <a xlink:href="#mattogrossodosul" :class="{ matogrossodosul : countryList.includes('mato-grosso-do-sul') }">
                    ...
                    <a xlink:href="#goias" :class="{ goias : countryList.includes('goias') }">
                    ...
                    <a xlink:href="#parana" :class="{ parana : countryList.includes('parana') }">
                    ...
                    <a xlink:href="#santacatarina" :class="{ santacatarina : countryList.includes('santa-catarina') }">
                    ...
                    <a xlink:href="#riograndedosul" :class="{ riograndedosul : countryList.includes('rio-grande-do-sul') }">
                    ...
                    <a xlink:href="#saopaulo" :class="{ saopaulo : countryList.includes('sao-paulo') }">
                    ...
                    <a xlink:href="#minasgerais" :class="{ minasgerais : countryList.includes('minas-gerais') }">
                    ...
                    <a xlink:href="#riodejaneiro" :class="{ riodejaneiro : countryList.includes('rio-de-janeiro') }">
                    ...
                    <a xlink:href="#espiritosanto" :class="{ espiritosanto : countryList.includes('espirito-santo') }">
                    ...
                    <a xlink:href="#distritofederal" :class="{ distritofederal : countryList.includes('distrito-federal') }">
                    ...
                    <a xlink:href="#paraiba" :class="{ paraiba : countryList.includes('paraiba') }">
            ...
            <div class="col-lg-6 dealership-resume">
                ...
                <p class="dealership-resume__text">A energia movimenta 210 milhões de brasileiros. Todos os dias, empresas têm o desafio de gerar, transmitir e distribuir energia elétrica para todos. Os novos tempos exigem crescimento e evolução, mas de forma sustentável.
                    ...
                    <br><br>
                    O Energy Future é a conexão de soluções inovadoras às oportunidades. O hub é um espaço para estimular esta integração do empreendedorismo brasileiro ao setor elétrico, fomentando conhecimento e relações de parceria. 
                    A inédita iniciativa reúne grandes concessionárias do país que avaliarão projetos, de acordo com regras próprias da chamada e com os critérios estabelecidos pelo Programa de Pesquisa e Desenvolvimento da ANEEL.
                    <br><br>
                    Você pode contribuir no desenvolvimento da energia elétrica no Brasil. Faça parte do Energy Future!
                    Porque a energia sempre se movimenta. E nós a movimentamos para o Futuro. </p>
            </div>            
